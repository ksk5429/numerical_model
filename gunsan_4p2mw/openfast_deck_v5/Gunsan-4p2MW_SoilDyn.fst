...
Gunsan 4.2 MW Tripod (v5.0.0 - derived from OC3 Tripod r-test)
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"Gunsan-4p2MW_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"Gunsan-4p2MW_AeroDyn.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"Gunsan-4p2MW_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"SeaState.dat"    SeaStFile       - Name of file containing sea state input parameters (quoted string)
"Gunsan-4p2MW_HydroDyn.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"Gunsan-4p2MW_SubDyn.dat"    SubFile         - Name of file containing sub-structural input parameters (quoted string)
"unused"      MooringFile     - Name of file containing mooring system input parameters (quoted string)
"unused"      IceFile         - Name of file containing ice input parameters (quoted string)
"Gunsan-4p2MW_SoilDyn.dat"      SoilFile        - Name of the file containing the SoilDyn input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
