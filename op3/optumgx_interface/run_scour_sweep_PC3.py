# -*- coding: utf-8 -*-
"""
Phase A3 - PC3: Scour depths 3m and 5m (Vmax + Hmax each)
===========================================================
Copy this file + run on third PC with OptumGX installed.
Output: results_scour_sweep_PC3/scour_sweep_PC3.csv
...
SCOUR_DEPTHS = [3.0, 5.0]

OUTPUT_DIR = Path(__file__).parent / 'results_scour_sweep_PC3'
...
if __name__ == "__main__":
    ...
    gx = GX()
    prj = gx.create_project("Scour_Sweep_PC3")
    ...
    for scour in SCOUR_DEPTHS:
        ...
        for probe in ['Vmax', 'Hmax']:
            ...
            try:
                lm, dt = build_model_with_scour(prj, scour, probe, "PC3")
            ...
            pd.DataFrame(results).to_csv(
                OUTPUT_DIR / 'scour_sweep_PC3.csv', index=False)

    print("\n" + "=" * 60)
    print("PC3 COMPLETE. Copy scour_sweep_PC3.csv back to main PC.")
    print("=" * 60)
