"""
Example 03: aero-elastic simulation runner.
...
Runs nrel_reference/oc4_jacket/5MW_OC4Jckt_DLL_WTurb_WavesIrr_MGrowth.fst
"""
import os
import subprocess
import sys
...
FST_FILE = 'nrel_reference/oc4_jacket/5MW_OC4Jckt_DLL_WTurb_WavesIrr_MGrowth.fst'


def main():
    if FST_FILE is None:
        print("No OpenFAST deck configured for example 03.")
    ...
    print(f"Running OpenFAST for example 03: NREL 5MW OC4 Jacket")
