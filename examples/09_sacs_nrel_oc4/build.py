...
def build():
    """Return a TowerModel for example 09."""
    # Make foundation args paths absolute relative to the repo root
    fnd_kwargs = {'stiffness_matrix': 'data/fem_results/K_6x6_oc4_jacket.csv', 'sacs_source': 'nrel_reference/sacs_jackets/nrel_oc4/NREL_OC4.sacs'}
...
if __name__ == "__main__":
    model = build()
    print(f"Built example: NREL OC4 jacket in SACS (PLAXIS-SACS benchmark)")
