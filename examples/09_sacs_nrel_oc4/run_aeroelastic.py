"""
Example 09: aero-elastic simulation runner.
...
def main():
    if FST_FILE is None:
        print("No OpenFAST deck configured for example 09.")
    ...
    print(f"Running OpenFAST for example 09: NREL OC4 jacket in SACS (PLAXIS-SACS benchmark)")
