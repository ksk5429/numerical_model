"""
Example 05: eigenvalue analysis runner.
...
def main():
    print("Example 05: NREL 5MW rotor+tower on Gunsan tripod (Op^3 isolation test)")
    print("=" * 70)
    ...
    results_path.write_text(json.dumps({
        "example_id": "05_nrel_5mw_on_gunsan_tripod",
