"""
Example 05: NREL 5MW rotor+tower on Gunsan tripod (Op^3 isolation test)
...
def build():
    """Return a TowerModel for example 05."""
...
if __name__ == "__main__":
    model = build()
    print(f"Built example: NREL 5MW rotor+tower on Gunsan tripod (Op^3 isolation test)")
