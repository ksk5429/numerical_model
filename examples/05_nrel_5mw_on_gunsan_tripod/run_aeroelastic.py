"""
Example 05: aero-elastic simulation runner.
...
def main():
    if FST_FILE is None:
        print("No OpenFAST deck configured for example 05.")
    ...
    print(f"Running OpenFAST for example 05: NREL 5MW rotor+tower on Gunsan tripod (Op^3 isolation test)")
