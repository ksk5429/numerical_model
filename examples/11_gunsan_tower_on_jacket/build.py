...
def build():
    """Return a TowerModel for example 11."""
    # Make foundation args paths absolute relative to the repo root
    fnd_kwargs = {'stiffness_matrix': 'data/fem_results/K_6x6_oc4_jacket.csv'}
...
if __name__ == "__main__":
    model = build()
    print(f"Built example: Gunsan U136 tower on equivalent jacket (Op^3 isolation test)")
