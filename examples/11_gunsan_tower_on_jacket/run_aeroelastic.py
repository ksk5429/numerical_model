"""
Example 11: aero-elastic simulation runner.
...
def main():
    if FST_FILE is None:
        print("No OpenFAST deck configured for example 11.")
    ...
    print(f"Running OpenFAST for example 11: Gunsan U136 tower on equivalent jacket (Op^3 isolation test)")
