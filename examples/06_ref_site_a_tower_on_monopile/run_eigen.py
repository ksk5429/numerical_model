"""
Example 06: eigenvalue analysis runner.
...
def main():
    print("Example 06: SiteA RT1 tower on equivalent monopile (Op^3 isolation test)")
    print("=" * 70)
    ...
    results_path.write_text(json.dumps({
        "example_id": "06_ref_site_a_tower_on_monopile",
