...
THE dissertation subject turbine. Gunsan 4.2 MW Unison
...
```bash
python examples/04_gunsan_4p2mw_tripod/run_eigen.py
```
...
python examples/04_gunsan_4p2mw_tripod/run_aeroelastic.py
```

Runs OpenFAST against `gunsan_4p2mw/openfast_deck/Gunsan-4p2MW.fst`.
