...
Runs gunsan_4p2mw/openfast_deck/Gunsan-4p2MW.fst
"""
import os
import subprocess
import sys
...
FST_FILE = 'gunsan_4p2mw/openfast_deck/Gunsan-4p2MW.fst'
...
def main():
    ...
    print(f"Running OpenFAST for example 04: Gunsan 4.2 MW on tripod suction bucket (as built)")
