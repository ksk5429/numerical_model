"""
Example 02: aero-elastic simulation runner.
...
Runs nrel_reference/openfast_rtest/5MW_OC3Mnpl_DLL_WTurb_WavesIrr/5MW_OC3Mnpl_DLL_WTurb_WavesIrr.fst
"""
import os
import subprocess
import sys
...
FST_FILE = 'nrel_reference/openfast_rtest/5MW_OC3Mnpl_DLL_WTurb_WavesIrr/5MW_OC3Mnpl_DLL_WTurb_WavesIrr.fst'


def main():
    if FST_FILE is None:
        print("No OpenFAST deck configured for example 02.")
    ...
    print(f"Running OpenFAST for example 02: NREL 5MW OC3 Monopile")
