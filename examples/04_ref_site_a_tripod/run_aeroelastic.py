"""
Example 04: aero-elastic simulation runner.
...
Runs site_a_ref4mw/openfast_deck/SiteA-Ref4MW.fst
"""
import os
import subprocess
import sys
...
FST_FILE = 'site_a_ref4mw/openfast_deck/SiteA-Ref4MW.fst'


def main():
    if FST_FILE is None:
        print("No OpenFAST deck configured for example 04.")
    ...
    print(f"Running OpenFAST for example 04: SiteA 4 MW class on tripod suction bucket (as built)")
