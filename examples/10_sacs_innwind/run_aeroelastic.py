"""
Example 10: aero-elastic simulation runner.
...
def main():
    if FST_FILE is None:
        print("No OpenFAST deck configured for example 10.")
    ...
    print(f"Running OpenFAST for example 10: INNWIND 10MW jacket in SACS (EU reference)")
