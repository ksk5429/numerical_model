...
def build():
    """Return a TowerModel for example 10."""
    # Make foundation args paths absolute relative to the repo root
    fnd_kwargs = {'sacs_source': 'nrel_reference/sacs_jackets/innwind/INNWIND.sacs', 'stiffness_matrix': 'data/fem_results/K_6x6_innwind_jacket.csv'}
...
if __name__ == "__main__":
    model = build()
    print(f"Built example: INNWIND 10MW jacket in SACS (EU reference)")
