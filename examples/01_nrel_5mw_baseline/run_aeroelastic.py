"""
Example 01: aero-elastic simulation runner.
...
def main():
    if FST_FILE is None:
        print("No OpenFAST deck configured for example 01.")
    ...
    print(f"Running OpenFAST for example 01: NREL 5MW Baseline (fixed base)")
