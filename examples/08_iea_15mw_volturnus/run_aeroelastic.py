"""
Example 08: aero-elastic simulation runner.
...
Runs nrel_reference/iea_15mw/OpenFAST_volturnus/IEA-15-240-RWT-UMaineSemi.fst
"""
import os
import subprocess
import sys
...
FST_FILE = 'nrel_reference/iea_15mw/OpenFAST_volturnus/IEA-15-240-RWT-UMaineSemi.fst'


def main():
    if FST_FILE is None:
        print("No OpenFAST deck configured for example 08.")
    ...
    print(f"Running OpenFAST for example 08: IEA 15MW on VolturnUS-S semi-submersible (floating)")
