...
def build():
    """Return a TowerModel for example 08."""
    # Make foundation args paths absolute relative to the repo root
    fnd_kwargs = {'stiffness_matrix': 'data/fem_results/K_6x6_volturnus_floating.csv'}
...
if __name__ == "__main__":
    model = build()
    print(f"Built example: IEA 15MW on VolturnUS-S semi-submersible (floating)")
