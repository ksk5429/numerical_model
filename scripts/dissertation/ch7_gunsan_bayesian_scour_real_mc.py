"""
Chapter 7 / Task A (v2): Bayesian identification of Gunsan scour
...
Procedure
---------
1. Load the 1794-row Gunsan MC database via
...
def main():
    ...
    ap.add_argument("--out",
                    default="PHD/ch7/gunsan_bayesian_scour_real_mc.json")
    args = ap.parse_args()
    ...
    result = {
        "task": "A (v2) - Gunsan Bayesian scour ID from REAL 1794 MC",
        "measurement": {
            "f1_Hz": args.measured,
            "sigma_Hz": args.sigma,
